...
import { SUPPORTED_LAGNUAGES } from '../constants/constants'
...
export async function translate({ fromLanguage, toLanguage, text }: {
  ...
  const fromCode = fromLanguage === 'auto' ? 'auto' : SUPPORTED_LAGNUAGES[fromLanguage]
  const toCode = SUPPORTED_LAGNUAGES[toLanguage]
